 ...
 * @author UsuariO
 */
public class IdiomaPc extends javax.swing.JFrame {

    /**
     * Creates new form IdiomaPc
     */
    public IdiomaPc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/idiomaa.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setText("Idioma Atual");

        lblIdioma.setBackground(new java.awt.Color(153, 153, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdiomaPc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
